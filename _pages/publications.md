...
<article class="publication-entry">
 ...
 <div class="publication-content">
  ...
  <p class="publication-authors">{% assign author_list = publi.authors | split: ", " %}{% for author in author_list %}{% assign author_name = author | strip %}{% assign author_key = "|" | append: author_name | downcase | append: "|" %}{% if lab_author_names contains author_key %}<span class="publication-lab-author">{{ author_name }}</span>{% if equal_contribution_author_names contains author_key %}<sup class="publication-author-note publication-equal-contribution-author">*</sup>{% endif %}{% if corresponding_author_names contains author_key %}<sup class="publication-author-note publication-corresponding-author">#</sup>{% endif %}{% else %}{{ author_name }}{% endif %}{% unless forloop.last %}, {% endunless %}{% endfor %}</p>
  {% if venue_html != "" %}
